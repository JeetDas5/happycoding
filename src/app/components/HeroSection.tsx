...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <h1 className="hero-anim-2 text-center font-extrabold text-[75px] md:text-[100px] lg:text-[150px] tracking-[-0.04em] leading-[0.85] bg-clip-text text-transparent bg-linear-to-b from-white via-white to-white/30 z-20 relative">
        <span className="block">HAPPY</span>
        <span className="block text-white/70">CODING</span>
      </h1>
      ...
      <div className="hero-anim-4 flex flex-col sm:flex-row gap-4 mt-10 z-20 relative">
        <Link
          href="#cta"
          className="group relative flex items-center gap-3 rounded-full px-3 py-2 pr-8 overflow-hidden border border-white/10 bg-linear-to-b from-white/6 via-white/2 to-white/6 backdrop-blur-xl hover:bg-primary/10 transition-all duration-300"
        ...
        >
          ...
          <span className="relative z-10 text-lg font-bold text-white tracking-tight">
            Join HappyCoding
          </span>
        </Link>
      ...
      <div className="hero-anim-5 flex flex-wrap items-center justify-center gap-6 mt-12 z-20 relative">
        {[
          ...
          <div key={stat?.label} className="flex items-center gap-2">
            <span className="text-lg font-bold text-white font-mono animate-count-glow">
              {stat?.value}
            </span>
